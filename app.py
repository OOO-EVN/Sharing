...
from handlers import IsAdminFilter, IsAllowedChatFilter, command_start_handler, batch_accept_handler, today_stats_handler, handle_text_messages, handle_photo_messages, handle_unsupported_content
...
def register_handlers():
    ...
    dp.register_message_handler(batch_accept_handler, IsAllowedChatFilter(), commands="batch_accept")
